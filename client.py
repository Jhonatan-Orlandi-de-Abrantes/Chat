...
messagebox.showerror('⚠️ATENÇÃO!⚠️', 'Para utilizar o chat é necessário que você tenha um VPN para conectar os membros da rede. - Após instalar e configurar o VPN, utilize o IP fornecido pelo arquivo "''server.py''" para conectar-se ao servidor!')
...
class ChatClient:
    def __init__(self, master):
        ...
        tk.Label(top, text='Usuário:').grid(row=0, column=0)
        ...
        self.btn_register = tk.Button(top, text='Registrar', command=self.do_register)
        ...
        tk.Label(name_frame, text='Apelido:').pack(side='left')
        self.ent_name = tk.Entry(name_frame)
        self.ent_name.pack(side='left', padx=6)
        self.btn_set_name = tk.Button(name_frame, text='Definir Apelido', command=self.do_set_name)
        ...
        self.txt_area.tag_config('user', foreground='#27A351')
        ...
        self.btn_send = tk.Button(bottom, text='Enviar ✏️', command=self.do_send)
